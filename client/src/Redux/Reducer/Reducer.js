  ...
  switch (action.type) {
    ...
    case FILTRADODEGENERO:
      const Xgeneros =
        action.payload === ""
          ? state.videoxpag
          : state.videoxpag.filter((e) => e.genres.includes(action.payload));
    ...
    case DELETE:
      const deleteVideogames = state.videofiltrados.filter(
