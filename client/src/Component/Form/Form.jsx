...
const Form = () => {
  const validateInput = (input) => {
    ...
    if (!input.description.length)
      error.description = "Debe ingresar un description";
  ...
  const optionchangeP = (e) => {
    ...
    setOption2([...option2, e.target.value]);
  };
        ...
        <form onSubmit={handleSubmit} className={style.formulario}>
          ...
          <div className={style.platform}>
            ...
            <input
              ...
              className={style.input}
            />
            <button type="button" onClick={ResetPlat} className={style.X}>
              X
            </button>
          ...
          <div className={style.genres}>
            ...
            <input
              ...
              className={style.input}
            />
            <button type="button" onClick={ResetGenre} className={style.X}>
              X
            </button>
